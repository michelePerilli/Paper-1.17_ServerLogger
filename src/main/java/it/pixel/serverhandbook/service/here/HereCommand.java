...
import static it.pixel.serverhandbook.service.TextManager.textColorByDimension;
...
public class HereCommand extends BaseService {
    ...
    public static void here(Player player) {
        ...
        Bukkit.getOnlinePlayers().forEach(p -> p.sendMessage(nome + TextManager.textInfo(" → ") + dimension + TextManager.textInfo(" • ") + coords));
    }
}
